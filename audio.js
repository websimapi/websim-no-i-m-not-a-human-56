...
/* add monologue + noise */
let monologueBuffer = null, noiseBuffer = null, monologueHandle = null;
...
export async function loadAllSounds(){
  ...
  monologueBuffer = await loadSound('I_couldnt_quite_remember.mp3');
}
...
export function stopMumbledMonologue(fadeOut=0.8){
  const h = monologueHandle; if (!h) return; monologueHandle = null;
  try {
